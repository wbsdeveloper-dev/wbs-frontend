...
export const BOT_PRIMARY_API = process.env.NEXT_PUBLIC_BOT_PRIMARY_API || "http://localhost:3006";
export const BOT_SECONDARY_API = process.env.NEXT_PUBLIC_BOT_SECONDARY_API || "http://localhost:3007";

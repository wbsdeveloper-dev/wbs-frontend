              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`
                    group relative min-w-max shrink-0 bg-white py-4 px-6 text-sm font-medium hover:bg-gray-50 focus:z-10 transition-colors
                    ${activeTab === tab.id ? "text-secondary border-b-2 border-secondary font-semibold" : "text-gray-500 border-b-2 border-transparent hover:text-gray-700"}
                  `}
                  >

...
import { Eye, EyeOff, ChevronDown, ChevronUp, Layers, X, Filter } from "lucide-react";
...
const pemasokData: Pemasok[] = [
  { id: 1, name: "PHE ONWJ", position: [-6.2, 106.8], wilayah: "Jawa Bagian Barat" },
  { id: 2, name: "Pertamina EP Subang", position: [-6.9175, 107.6191], wilayah: "Jawa Bagian Barat" },
  { id: 3, name: "ConocoPhillips Corridor", position: [-6.9667, 110.4167], wilayah: "Jawa Tengah" },
  { id: 4, name: "PGN Surabaya", position: [-7.2575, 112.7521], wilayah: "Jawa Timur" },
  { id: 5, name: "Medco E&P Lematang", position: [-2.9761, 104.7754], wilayah: "Sumatera Selatan" },
  { id: 6, name: "ExxonMobil Cepu", position: [-7.1, 111.8], wilayah: "Jawa Timur" },
  { id: 7, name: "Chevron Riau", position: [1.4, 102.1], wilayah: "Sumatera Tengah" },
  { id: 8, name: "Santos Madura", position: [-7.0, 113.5], wilayah: "Jawa Timur" },
  { id: 9, name: "VICO Kalimantan", position: [-0.5, 117.1], wilayah: "Kalimantan" },
  { id: 10, name: "Star Energy Salak", position: [-6.7, 106.7], wilayah: "Jawa Bagian Barat" },
  { id: 11, name: "BP Tangguh", position: [-2.8, 132.3], wilayah: "Papua" },
  { id: 12, name: "Petrochina Jabung", position: [-1.5, 103.5], wilayah: "Jambi" },
  { id: 13, name: "PetroChina Jambi", position: [-1.6, 103.6], wilayah: "Jambi" },
  { id: 14, name: "Premier Oil Sumatra", position: [1.2, 97.8], wilayah: "Sumatera Tengah" },
  { id: 15, name: "Husky CNOOC Madura", position: [-7.1, 113.9], wilayah: "Jawa Timur" },
];

// Enhanced Pembangkit Data with Kapasitas, Wilayah, and Kepemilikan (20 locations)
const pembangkitData: Pembangkit[] = [
  { id: 1, name: "PLTU Suralaya", jenis: "PLTU", kapasitas: "3,400 MW", position: [-5.934, 106.025], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN IP" },
  { id: 2, name: "PLTA Cirata", jenis: "PLTA", kapasitas: "1,008 MW", position: [-6.729, 107.357], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN IP" },
  { id: 3, name: "PLTU Paiton", jenis: "PLTU", kapasitas: "4,710 MW", position: [-7.716, 113.56], wilayah: "Jawa Timur", kepemilikan: "IPP" },
  { id: 4, name: "PLTG Muara Karang", jenis: "PLTG", kapasitas: "900 MW", position: [-6.109, 106.787], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN NP" },
  { id: 5, name: "PLTA Saguling", jenis: "PLTA", kapasitas: "700 MW", position: [-6.901, 107.328], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN IP" },
  { id: 6, name: "PLTU Tanjung Jati", jenis: "PLTU", kapasitas: "2,640 MW", position: [-6.432, 110.65], wilayah: "Jawa Tengah", kepemilikan: "IPP" },
  { id: 7, name: "PLTU Asam Asam", jenis: "PLTU", kapasitas: "230 MW", position: [-3.9, 114.7], wilayah: "Kalimantan", kepemilikan: "PLN" },
  { id: 8, name: "PLTU Ombilin", jenis: "PLTU", kapasitas: "400 MW", position: [-0.65, 100.75], wilayah: "Sumatera Tengah", kepemilikan: "PLN" },
  { id: 9, name: "PLTU Barru", jenis: "PLTU", kapasitas: "100 MW", position: [-4.42, 119.62], wilayah: "Sulawesi", kepemilikan: "PLN NP" },
  { id: 10, name: "PLTG Belawan", jenis: "PLTG", kapasitas: "1,100 MW", position: [3.784, 98.65], wilayah: "Sumatera Tengah", kepemilikan: "PLN" },
  { id: 11, name: "PLTGU Gresik", jenis: "PLTGU", kapasitas: "2,300 MW", position: [-7.16, 112.65], wilayah: "Jawa Timur", kepemilikan: "PLN IP" },
  { id: 12, name: "PLTGU Muara Tawar", jenis: "PLTGU", kapasitas: "3,450 MW", position: [-6.2, 107.1], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN IP" },
  { id: 13, name: "PLTGU Tanjung Priok", jenis: "PLTGU", kapasitas: "1,750 MW", position: [-6.1, 106.87], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN NP" },
  { id: 14, name: "PLTU Cirebon", jenis: "PLTU", kapasitas: "660 MW", position: [-6.75, 108.55], wilayah: "Jawa Bagian Barat", kepemilikan: "IPP" },
  { id: 15, name: "PLTU Indramayu", jenis: "PLTU", kapasitas: "990 MW", position: [-6.35, 108.35], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN" },
  { id: 16, name: "PLTGU Tambak Lorok", jenis: "PLTGU", kapasitas: "1,400 MW", position: [-6.95, 110.45], wilayah: "Jawa Tengah", kepemilikan: "PLN IP" },
  { id: 17, name: "PLTU Banten", jenis: "PLTU", kapasitas: "670 MW", position: [-6.0, 106.15], wilayah: "Jawa Bagian Barat", kepemilikan: "IPP" },
  { id: 18, name: "PLTG Grati", jenis: "PLTG", kapasitas: "485 MW", position: [-7.68, 113.25], wilayah: "Jawa Timur", kepemilikan: "PLN NP" },
  { id: 19, name: "PLTU Pacitan", jenis: "PLTU", kapasitas: "630 MW", position: [-8.15, 111.1], wilayah: "Jawa Timur", kepemilikan: "IPP" },
  { id: 20, name: "PLTU Lontar", jenis: "PLTU", kapasitas: "945 MW", position: [-6.08, 106.35], wilayah: "Jawa Bagian Barat", kepemilikan: "PLN" },
];
...
export default function Map() {
  ...
  const [selectedKepemilikan, setSelectedKepemilikan] = useState<string[]>(kepemilikanOptions);
  ...
  const filteredPembangkit = useMemo(() => {
    return pembangkitData.filter((p) => {
      ...
      if (selectedKepemilikan.length > 0 && !selectedKepemilikan.includes(p.kepemilikan)) return false;
      return true;
    });
  ...
  const filteredRoutes = useMemo(() => {
    ...
    return jalurPipa.filter((jalur) => {
      return visiblePemasokIds.includes(jalur.pemasokId) && visiblePembangkitIds.includes(jalur.pembangkitId);
    });

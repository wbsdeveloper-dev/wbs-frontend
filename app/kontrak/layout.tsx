...
export const metadata: Metadata = {
  title: "PLN Dashboard - Kontrak & Dokumen",
  description: "Kontrak & Dokumen untuk Dashboard PLN",
};

export default function KontrakLayout({
  children,
}: {
  ...
  return (
    <div
      className={`${redditSans.variable} ${geistMono.variable} antialiased flex h-screen relative font-sans overflow-x-hidden`}
    >
